...
import { useDeleteRecurringTransactionHook, useFilterRecurringTransaction } from './recurring-hook'
...
export default function RecurringTransactionList() {
    ...
    const { mutate:deleteRecurringMutation } = useDeleteRecurringTransactionHook()
    return (
   <div className="grid lg:grid-cols-2 grid-cols-1 w-full justify-center gap-5 place-items-center">
    {
    isLoading ? (
                      ...
                      <div>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent className={'bg-card border border-highlight'}>
                            ...
                            <DropdownMenuItem onClick={()=>deleteRecurringMutation(item?.id)}>
                              Delete
                            </DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>                                                   
